...
const UnitContainer = ({ conversionType, numberOfUnits }) => {
  const RoundToHundredths =(val) => {
    ...
    const Units = [
      ...
      {label: 'Ounce', color: '#008c1c', value: OuncesConverter(conversionType, numberOfUnits)},
      {label: 'Pint', color: '#070091', value: PintsConverter(conversionType, numberOfUnits)},
      {label: 'Quart', color: '#560084', value: QuartsConverter(conversionType, numberOfUnits)},
    ]
